...
var leftBtn = document.querySelector('#minus');
var rightBtn = document.querySelector('#plus');
...
function changeTimer(timeNode, incr) {
    if (incr === void 0) { incr = true; }
    if (incr) {
        return function () {
            var changeItem = +timeNode.innerHTML;
            changeItem++;
...
function startTimer(timeNode, labelNode) {
